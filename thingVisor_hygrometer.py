...
class FetcherThread(Thread):    #Edites in 2 places
    ...
    def run(self):      #Edites
        while True:
            ...
            context_hello.update([ngsiLdEntity1])   # update context status for virtual thing hello
...
if __name__ == '__main__':  #Edites
    ...
    contexts = {v_thing_ID1: context_hello}
