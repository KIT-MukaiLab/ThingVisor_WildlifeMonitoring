...
class MqttControlThread(Thread):    #Edites in 3 places
    ...
    def run(self):                                          #Edites
        ...
        mqtt_control_client.subscribe(v_thing_topic2 + '/' + in_control_suffix)
